...
//    grille = add_Value(grille, 0, 0, 4);
//    grille = add_Value(grille, 0, 2, 6);
//    grille = add_Value(grille, 0, 5, 7);
//    grille = add_Value(grille, 0, 8, 2);
//    grille = add_Value(grille, 1, 2, 8);
//    grille = add_Value(grille, 1, 4, 9);
//    grille = add_Value(grille, 1, 7, 4);
//    grille = add_Value(grille, 2, 3, 2);
//    grille = add_Value(grille, 2, 4, 8);
//    grille = add_Value(grille, 2, 6, 1);
//    grille = add_Value(grille, 2, 7, 9);
//    grille = add_Value(grille, 3, 0, 5);
//    grille = add_Value(grille, 3, 1, 3);
//    grille = add_Value(grille, 3, 3, 6);
//    grille = add_Value(grille, 3, 5, 2);
//    grille = add_Value(grille, 3, 6, 9);
//    grille = add_Value(grille, 4, 6, 6);
//    grille = add_Value(grille, 4, 8, 3);
//    grille = add_Value(grille, 6, 0, 1);
//    grille = add_Value(grille, 6, 7, 2);
//    grille = add_Value(grille, 7, 2, 2);
//    grille = add_Value(grille, 7, 4, 1);
//    grille = add_Value(grille, 8, 1, 7);
//    grille = add_Value(grille, 8, 2, 4);
//    grille = add_Value(grille, 8, 3, 9);
//    Show_grid(grille, LENGTH);
    mysdl(grille);

    verifGrid(grille, LENGTH);
//    grille = deleteAvalue(grille, 0,0);
//    Show_grid(grille, LENGTH);
